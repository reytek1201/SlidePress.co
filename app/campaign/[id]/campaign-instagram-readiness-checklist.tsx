interface InstagramReadinessItem {
  label: string;
  done: boolean;
  locked: boolean;
}

interface CampaignInstagramReadinessChecklistProps {
  hasCaptions: boolean;
...
export default function CampaignInstagramReadinessChecklist({
  hasCaptions,
  hasVideoExport,
  connected,
  alreadyPublished,
}: CampaignInstagramReadinessChecklistProps) {
  const items: InstagramReadinessItem[] = [
    {
