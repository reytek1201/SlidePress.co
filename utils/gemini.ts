...
export async function generateCampaignContent(
  ...
  userParts.push({
    text: [
      ...
      "(object with position: one of upper_left, upper_center, upper_right, center_left, center, center_right,",
      "lower_left, lower_center, lower_right; and background_tone: light, dark, or mixed).",
      "Image prompts must match the requested aspect ratio framing.",
      "",
      "text_region rules (best-effort placement hint for a future text overlay — not a legibility guarantee):",
      "- After writing each slide's image_prompt, choose text_region.position where that scene would have",
      "  calm, visually appropriate space for headline text once rendered.",
      "- Set background_tone to light (prefer light/white overlay text), dark (prefer dark overlay text),",
      "  or mixed (busy/varied region — overlay styling will need extra contrast help).",
