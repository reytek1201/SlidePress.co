...
| `GET /api/cron/publish-scheduled-posts` | Fire due scheduled platform posts (Vercel Cron, every 5 min) |
...
| Cron | `CRON_SECRET` (Vercel Cron → refill-free-credits + publish-scheduled-posts) |
